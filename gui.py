# -*- coding: utf-8 -*-
"""
Bifrost Main Window UI Definition

This file defines the main window UI for the Bifrost application.
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.endstopLabelArt1 = QtWidgets.QLabel(self.frame_7)
        self.endstopLabelArt1.setGeometry(QtCore.QRect(10, 63, 80, 16))
        self.endstopLabelArt1.setText("ES: ---")
        self.endstopLabelArt1.setStyleSheet("background-color: rgb(200, 200, 200); padding: 2px; border-radius: 3px;")
        self.endstopLabelArt1.setObjectName("endstopLabelArt1")
        ...
        self.endstopLabelArt2 = QtWidgets.QLabel(self.frame_8)
        self.endstopLabelArt2.setGeometry(QtCore.QRect(10, 63, 80, 16))
        self.endstopLabelArt2.setText("ES: ---")
        self.endstopLabelArt2.setStyleSheet("background-color: rgb(200, 200, 200); padding: 2px; border-radius: 3px;")
        self.endstopLabelArt2.setObjectName("endstopLabelArt2")
        ...
        self.endstopLabelArt3 = QtWidgets.QLabel(self.frame_9)
        self.endstopLabelArt3.setGeometry(QtCore.QRect(10, 63, 80, 16))
        self.endstopLabelArt3.setText("ES: ---")
        self.endstopLabelArt3.setStyleSheet("background-color: rgb(200, 200, 200); padding: 2px; border-radius: 3px;")
        self.endstopLabelArt3.setObjectName("endstopLabelArt3")
        ...
        self.endstopLabelArt4 = QtWidgets.QLabel(self.frame_10)
        self.endstopLabelArt4.setGeometry(QtCore.QRect(10, 63, 80, 16))
        self.endstopLabelArt4.setText("ES: ---")
        self.endstopLabelArt4.setStyleSheet("background-color: rgb(200, 200, 200); padding: 2px; border-radius: 3px;")
        self.endstopLabelArt4.setObjectName("endstopLabelArt4")
        ...
        self.endstopLabelArt5 = QtWidgets.QLabel(self.frame_11)
        self.endstopLabelArt5.setGeometry(QtCore.QRect(10, 63, 80, 16))
        self.endstopLabelArt5.setText("ES: ---")
        self.endstopLabelArt5.setStyleSheet("background-color: rgb(200, 200, 200); padding: 2px; border-radius: 3px;")
        self.endstopLabelArt5.setObjectName("endstopLabelArt5")
        ...
        self.endstopLabelArt6 = QtWidgets.QLabel(self.frame_12)
        self.endstopLabelArt6.setGeometry(QtCore.QRect(10, 63, 80, 16))
        self.endstopLabelArt6.setText("ES: ---")
        self.endstopLabelArt6.setStyleSheet("background-color: rgb(200, 200, 200); padding: 2px; border-radius: 3px;")
        self.endstopLabelArt6.setObjectName("endstopLabelArt6")
